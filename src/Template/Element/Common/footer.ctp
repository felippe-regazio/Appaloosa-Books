...
<footer class="ap-footer">
	<div class="ap-footer__content">
		<div class="a"
			...
			<div class="justify-proportional">
				<a href="<?= Router::url(['controller'=>'appaloosa', 'action' => 'info#friends']); ?>">
					<svg viewBox="0 0 56 20"><text x="0" y="15">Doação</text></svg>
				</a>
		...
		<div class="b"
			...
			<h3># A EDITORA</h3>
	 		<a target="_blank" href="<?= Router::url(['controller'=>'appaloosa', 'action' => 'terms']); ?>">
	 			<svg viewBox="0 0 150 20"><text x="0" y="15">Termos e Condições</text></svg>
	 		</a>
		...
		<div class="c"
			...
			<a href="/" class="toggle-contact">
				<svg viewBox="0 0 186 20"><text x="0" y="15">Críticas, Elogios ou Bugs</text></svg>
			</a>
		</div>
		<div class="d"
			 data-aos="fade-left" 
